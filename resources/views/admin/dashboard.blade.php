...
<head>
    ...
    <title>{{ auth()->user()->role === 'admin' ? 'Dashboard Admin' : 'Dashboard Super Admin' }} - Itinerary Wisata</title>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            <div class="header-left">
                <h1>{{ auth()->user()->role === 'admin' ? 'Dashboard Admin' : 'Dashboard Super Admin' }}</h1>
                <p>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-label">{{ auth()->user()->role === 'admin' ? 'Total Wisatawan' : 'Total Pengguna' }}</div>
                </div>
            </div>
            <div class="stat-card">
        ...
        <div class="dashboard-content">
            ...
            <div class="quick-actions">
                <a href="{{ route('admin.user.index') }}" class="action-card">
                    ...
                    <div class="action-title">{{ auth()->user()->role === 'admin' ? 'Kelola Wisatawan' : 'Kelola Pengguna' }}</div>
                    <div class="action-desc">Manajemen data {{ auth()->user()->role === 'admin' ? 'wisatawan' : 'pengguna sistem' }}</div>
